...
void Task1() {
	...
	puts("* Для лёгкого уровня сложности необходимо, чтобы в каждом столбце выполнялись правила игры;\n* Для нормального уровня сложности необходимо, чтобы в первых 4 столбах по строкам, далее в 5 и 6 столбцах по столбцам, и в левом нижнем углу останется квадрат, везде здесь должны выполняться правила игры;\n* Для сложного уровня необходимо, чтобы первые четыре столбца и вторые четыре стобца подходили под правила игры.\n");
	puts("Для вас представлен пример, когда игра считается завершённой(смотреть как сложный уровень игры):");
	char arpolbut[B][B] = {
		{'2', '1', '4', '3', '2', '1', '3', '4'},
		{'4', '2', '1', '3', '3', '2', '1', '4'},
		{'3', '4', '1', '2', '1', '4', '2', '3'},
